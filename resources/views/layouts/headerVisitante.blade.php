    ...
    <ul class="navbar-nav " style="flex-grow: 1;">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          @if (Auth::user()->isadmin())
          <a class="dropdown-item" href="http://localhost/urumarkets/public/VermiPerfil">Ver mi Ventas</a>
          @else
          <a class="dropdown-item" href="http://localhost/urumarkets/public/MisCompras">Ver mi Compras</a>
          @endif
        </div>
      </li>
      <li class="nav-item">
